...
def go_deps():
    ...
    go_repository(
        ...
        patch_args = ["-p1"],
        patches = ["//:build/0001-cloudflare.patch"],
    ...
    go_repository(
        ...
        sum = "h1:yg18CpDvvfA6SQuTVIyWDbA/lhpzdCOkN2ddl02VG7g=",
        version = "v3.112.1-0.20240415121624-fc23f9bb0851",
    )
    go_repository(
        name = "com_github_pulumi_pulumi_sdk_v3",
        importpath = "github.com/pulumi/pulumi/sdk/v3",
        sum = "h1:NcVs/M+/YRGKAJwSTpR9Yqjqbt+EgiV0HvG3+31C52w=",
        version = "v3.112.1-0.20240415121624-fc23f9bb0851",
    )
    go_repository(
