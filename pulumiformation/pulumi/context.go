...
// The value passed to resource must be a pointer to a struct. The fields of this struct that correspond to output
// properties of the resource must have types that are assignable from Output, and must have a `pulumi` tag that
// records the name of the corresponding output property. The struct must embed either the PendingResourceState or the
...
func (ctx *Context) registerResource(
	t, name string, props Input, resource Resource, remote bool,
	opts ...ResourceOption) (*PendingResourceState, error) {
	if t == "" {
...
func (ctx *Context) RegisterComponentResource(
	t, name string, resource ComponentResource, opts ...ResourceOption) (*PendingResourceState, error) {

	return ctx.RegisterResource(t, name, nil /*props*/, resource, opts...)
}

func (ctx *Context) RegisterRemoteComponentResource(
	t, name string, props Input, resource ComponentResource, opts ...ResourceOption) (*PendingResourceState, error) {
...
func makePendingResourceState(t, name string, resourceV Resource, providers map[string]ProviderResource,
	...
	// Check to see if a value of exactly `*PendingResourceState`, `*CustomResourceState`, or `*ProviderResourceState` was
	// provided.
	...
	// Populate PendingResourceState resolvers. (Pulled into function to keep the nil-ness linter check happy).
	populatePendingResourceStateResolvers := func() {
	...
	populatePendingResourceStateResolvers()
