...
# dependency. Only the root Go module ships in the released binaries, so only bumps to
# the root go.mod get entries. No-op for anything else (CI, tooling, testdata).
#
